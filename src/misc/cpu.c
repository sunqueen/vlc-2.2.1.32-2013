...
#include "cpu_asm.h"			// sunqueen add
...
// sunqueen modify start
    ...
    asm volatile ( "push %%ebx\n\t"
                 ...
                 : "cc" );
#endif
    cover_vlc_CPU_init1(&i_eax, &i_ebx);
// sunqueen modify end
...
//    cpuid( 0x00000000 );
    cover_cpuid(0x00000000, &i_eax, &i_ebx, &i_ecx, &i_edx);			// sunqueen modify
...
//    cpuid( 0x00000001 );
    cover_cpuid(0x00000001, &i_eax, &i_ebx, &i_ecx, &i_edx);			// sunqueen modify
# if !defined (__MMX__)
    if( ! (i_edx & 0x00800000) )
        goto out;
# endif
...
//    cpuid( 0x80000000 );
    cover_cpuid(0x80000000, &i_eax, &i_ebx, &i_ecx, &i_edx);			// sunqueen modify
...
//    cpuid( 0x80000001 );
    cover_cpuid(0x80000001, &i_eax, &i_ebx, &i_ecx, &i_edx);			// sunqueen modify
