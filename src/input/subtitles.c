...
//            char tmp_fname_noext[strlen( psz_name ) + 1];
            char *tmp_fname_noext = (char *)malloc(strlen( psz_name ) + 1);			// sunqueen modify
//            char tmp_fname_trim[strlen( psz_name ) + 1];
            char *tmp_fname_trim = (char *)malloc(strlen( psz_name ) + 1);			// sunqueen modify
//            char tmp_fname_ext[strlen( psz_name ) + 1];
            char *tmp_fname_ext = (char *)malloc(strlen( psz_name ) + 1);			// sunqueen modify
            const char *tmp;
...
//                char psz_path[strlen( psz_dir ) + strlen( psz_name ) + 2];
                char *psz_path = (char *)malloc(strlen( psz_dir ) + strlen( psz_name ) + 2);			// sunqueen modify
                struct stat st;
