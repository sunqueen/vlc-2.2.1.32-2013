 ...
 * $Id: b27250b347400241d361ee0bb902f6ed540ca93b $
 *
...
//        char *ppsz_epg_info[i_epg_info];
		char **ppsz_epg_info = (char **)malloc(sizeof(char *) * i_epg_info);		// sunqueen modify

		memset(ppsz_epg_info, '\0', (sizeof(char *) * i_epg_info));			// sunqueen add
        for( int i = 0; i < p_item->i_epg; i++ )
        {
