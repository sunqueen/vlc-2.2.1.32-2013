...
const QMetaObjectExtraData QWinEventNotifier::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QWinEventNotifier::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWinEventNotifier,
      qt_meta_data_QWinEventNotifier, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QWinEventNotifier::getStaticMetaObject() { return staticMetaObject; }
