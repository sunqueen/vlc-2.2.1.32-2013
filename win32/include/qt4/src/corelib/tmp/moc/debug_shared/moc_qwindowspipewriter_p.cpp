...
static const char qt_meta_stringdata_QWindowsPipeWriter[] = {
    "QWindowsPipeWriter\0\0canWrite()\0bytes\0"
...
void QWindowsPipeWriter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        QWindowsPipeWriter *_t = static_cast<QWindowsPipeWriter *>(_o);
        switch (_id) {
        case 0: _t->canWrite(); break;
...
const QMetaObjectExtraData QWindowsPipeWriter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QWindowsPipeWriter::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QWindowsPipeWriter,
      qt_meta_data_QWindowsPipeWriter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QWindowsPipeWriter::getStaticMetaObject() { return staticMetaObject; }
