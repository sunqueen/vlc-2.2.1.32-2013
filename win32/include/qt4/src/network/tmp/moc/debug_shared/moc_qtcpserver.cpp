...
const QMetaObjectExtraData QTcpServer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTcpServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTcpServer,
      qt_meta_data_QTcpServer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QTcpServer::getStaticMetaObject() { return staticMetaObject; }
