...
const QMetaObjectExtraData QTcpSocket::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTcpSocket::staticMetaObject = {
    { &QAbstractSocket::staticMetaObject, qt_meta_stringdata_QTcpSocket,
      qt_meta_data_QTcpSocket, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QTcpSocket::getStaticMetaObject() { return staticMetaObject; }
