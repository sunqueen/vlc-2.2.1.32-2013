...
const QMetaObjectExtraData QTextTable::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTextTable::staticMetaObject = {
    { &QTextFrame::staticMetaObject, qt_meta_stringdata_QTextTable,
      qt_meta_data_QTextTable, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QTextTable::getStaticMetaObject() { return staticMetaObject; }
