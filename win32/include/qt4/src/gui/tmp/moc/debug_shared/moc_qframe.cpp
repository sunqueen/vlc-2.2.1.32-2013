...
const QMetaObjectExtraData QFrame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QFrame::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QFrame,
      qt_meta_data_QFrame, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QFrame::getStaticMetaObject() { return staticMetaObject; }
