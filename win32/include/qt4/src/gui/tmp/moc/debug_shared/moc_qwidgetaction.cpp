...
const QMetaObjectExtraData QWidgetAction::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QWidgetAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_QWidgetAction,
      qt_meta_data_QWidgetAction, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QWidgetAction::getStaticMetaObject() { return staticMetaObject; }
