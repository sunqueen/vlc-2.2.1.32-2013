...
static const uint qt_meta_data_QGraphicsColorizeEffect[] = {
 ...
 // properties: name, type, flags
      25,  122, 0x43495103,
      52,  129, ((uint)QMetaType::QReal << 24) | 0x00495103,
...
static const uint qt_meta_data_QGraphicsBlurEffect[] = {
 ...
 // properties: name, type, flags
      21,  136, ((uint)QMetaType::QReal << 24) | 0x00495103,
     152,  142, 0x0049510b,
...
static const uint qt_meta_data_QGraphicsDropShadowEffect[] = {
 ...
 // properties: name, type, flags
      27,  271, 0x1a495103,
     285,  279, ((uint)QMetaType::QReal << 24) | 0x00495103,
     293,  279, ((uint)QMetaType::QReal << 24) | 0x00495103,
      57,  279, ((uint)QMetaType::QReal << 24) | 0x00495103,
      93,  301, 0x43495103,
...
static const uint qt_meta_data_QGraphicsOpacityEffect[] = {
 ...
 // properties: name, type, flags
      24,  127, ((uint)QMetaType::QReal << 24) | 0x00495103,
     140,  133, 0x42495103,
