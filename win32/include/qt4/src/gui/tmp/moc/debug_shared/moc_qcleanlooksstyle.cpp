...
void QCleanlooksStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QCleanlooksStyle *_t = static_cast<QCleanlooksStyle *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QCleanlooksStyle::staticMetaObjectExtraData = {
...
const QMetaObject QCleanlooksStyle::staticMetaObject = {
    { &QWindowsStyle::staticMetaObject, qt_meta_stringdata_QCleanlooksStyle,
      qt_meta_data_QCleanlooksStyle, &staticMetaObjectExtraData }
};
