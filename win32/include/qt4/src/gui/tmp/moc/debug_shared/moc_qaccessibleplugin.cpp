...
const QMetaObjectExtraData QAccessiblePlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QAccessiblePlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAccessiblePlugin,
      qt_meta_data_QAccessiblePlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QAccessiblePlugin::getStaticMetaObject() { return staticMetaObject; }
