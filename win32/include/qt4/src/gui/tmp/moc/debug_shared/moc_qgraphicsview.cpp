...
static const uint qt_meta_data_QGraphicsView[] = {
 ...
 // enum data: key, value
     ...
     881, uint(QGraphicsView::IndirectPainting),
...
void QGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateScene((*reinterpret_cast< const QList<QRectF>(*)>(_a[1]))); break;
        case 1: _t->invalidateScene((*reinterpret_cast< const QRectF(*)>(_a[1])),(*reinterpret_cast< QGraphicsScene::SceneLayers(*)>(_a[2]))); break;
        case 2: _t->invalidateScene((*reinterpret_cast< const QRectF(*)>(_a[1]))); break;
        case 3: _t->invalidateScene(); break;
        case 4: _t->updateSceneRect((*reinterpret_cast< const QRectF(*)>(_a[1]))); break;
        case 5: _t->setupViewport((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 6: _t->d_func()->_q_setViewportCursor((*reinterpret_cast< const QCursor(*)>(_a[1]))); break;
        case 7: _t->d_func()->_q_unsetViewportCursor(); break;
        default: ;
        }
    }
}
...
static const QMetaObjectAccessor qt_meta_extradata_QGraphicsView[] = {
...
const QMetaObjectExtraData QGraphicsView::staticMetaObjectExtraData = {
    qt_meta_extradata_QGraphicsView,  qt_static_metacall 
};

const QMetaObject QGraphicsView::staticMetaObject = {
    { &QAbstractScrollArea::staticMetaObject, qt_meta_stringdata_QGraphicsView,
      qt_meta_data_QGraphicsView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGraphicsView::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
