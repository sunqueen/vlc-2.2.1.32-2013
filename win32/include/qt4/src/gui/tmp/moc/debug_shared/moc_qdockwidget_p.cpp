...
const QMetaObjectExtraData QDockWidgetLayout::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QDockWidgetLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QDockWidgetLayout,
      qt_meta_data_QDockWidgetLayout, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDockWidgetLayout::getStaticMetaObject() { return staticMetaObject; }
