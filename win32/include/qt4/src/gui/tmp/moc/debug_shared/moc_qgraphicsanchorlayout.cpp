...
static const uint qt_meta_data_QGraphicsAnchor[] = {
 ...
 // properties: name, type, flags
      22,   16, ((uint)QMetaType::QReal << 24) | 0x00095107,
      50,   30, 0x0009510b,
...
const QMetaObjectExtraData QGraphicsAnchor::staticMetaObjectExtraData = {
    qt_meta_extradata_QGraphicsAnchor,  qt_static_metacall 
};

const QMetaObject QGraphicsAnchor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGraphicsAnchor,
      qt_meta_data_QGraphicsAnchor, &staticMetaObjectExtraData }
};
