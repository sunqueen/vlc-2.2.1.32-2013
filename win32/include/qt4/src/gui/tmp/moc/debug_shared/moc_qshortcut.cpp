...
const QMetaObjectExtraData QShortcut::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QShortcut::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QShortcut,
      qt_meta_data_QShortcut, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QShortcut::getStaticMetaObject() { return staticMetaObject; }
