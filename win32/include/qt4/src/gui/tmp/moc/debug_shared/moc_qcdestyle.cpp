...
void QCDEStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QCDEStyle *_t = static_cast<QCDEStyle *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QCDEStyle::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QCDEStyle::staticMetaObject = {
    { &QMotifStyle::staticMetaObject, qt_meta_stringdata_QCDEStyle,
      qt_meta_data_QCDEStyle, &staticMetaObjectExtraData }
};
