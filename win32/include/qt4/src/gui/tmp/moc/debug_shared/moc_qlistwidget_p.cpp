...
const QMetaObjectExtraData QListModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QListModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_QListModel,
      qt_meta_data_QListModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QListModel::getStaticMetaObject() { return staticMetaObject; }
