...
static const uint qt_meta_data_QTextDocument[] = {
 ...
 // properties: name, type, flags
     ...
     425,  361, 0x01095103,
     442,  391, 0x16095001,
     453,  447, ((uint)QMetaType::QReal << 24) | 0x00095103,
     467,  463, 0x02095001,
     478,  447, ((uint)QMetaType::QReal << 24) | 0x00095103,
     498,  490, 0x0a095103,
     516,  463, 0x02095103,
     534,  447, ((uint)QMetaType::QReal << 24) | 0x00095103,
...
void QTextDocument::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->documentLayoutChanged(); break;
        case 9: _t->undo(); break;
        case 10: _t->redo(); break;
        case 11: _t->appendUndoItem((*reinterpret_cast< QAbstractUndoItem*(*)>(_a[1]))); break;
        case 12: _t->setModified((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 13: _t->setModified(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QTextDocument::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTextDocument::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTextDocument,
      qt_meta_data_QTextDocument, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QTextDocument::getStaticMetaObject() { return staticMetaObject; }
