...
const QMetaObjectExtraData QStylePlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QStylePlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QStylePlugin,
      qt_meta_data_QStylePlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QStylePlugin::getStaticMetaObject() { return staticMetaObject; }
