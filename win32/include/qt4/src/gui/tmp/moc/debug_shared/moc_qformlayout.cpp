...
const QMetaObjectExtraData QFormLayout::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QFormLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QFormLayout,
      qt_meta_data_QFormLayout, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QFormLayout::getStaticMetaObject() { return staticMetaObject; }
