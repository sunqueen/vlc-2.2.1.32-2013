...
const QMetaObjectExtraData QSizeGrip::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QSizeGrip::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QSizeGrip,
      qt_meta_data_QSizeGrip, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QSizeGrip::getStaticMetaObject() { return staticMetaObject; }
