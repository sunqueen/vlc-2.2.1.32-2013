...
const QMetaObjectExtraData QRubberBand::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QRubberBand::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QRubberBand,
      qt_meta_data_QRubberBand, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QRubberBand::getStaticMetaObject() { return staticMetaObject; }
