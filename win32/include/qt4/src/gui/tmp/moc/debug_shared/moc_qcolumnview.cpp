...
const QMetaObjectExtraData QColumnView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QColumnView::staticMetaObject = {
    { &QAbstractItemView::staticMetaObject, qt_meta_stringdata_QColumnView,
      qt_meta_data_QColumnView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QColumnView::getStaticMetaObject() { return staticMetaObject; }
