...
void QInputContextPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QInputContextPlugin::staticMetaObjectExtraData = {
...
const QMetaObject QInputContextPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QInputContextPlugin,
      qt_meta_data_QInputContextPlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QInputContextPlugin::getStaticMetaObject() { return staticMetaObject; }
