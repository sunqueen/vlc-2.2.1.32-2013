...
const QMetaObjectExtraData QDialogButtonBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QDialogButtonBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QDialogButtonBox,
      qt_meta_data_QDialogButtonBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDialogButtonBox::getStaticMetaObject() { return staticMetaObject; }
