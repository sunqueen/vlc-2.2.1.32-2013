...
void QProxyStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        QProxyStyle *_t = static_cast<QProxyStyle *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QProxyStyle::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QProxyStyle::staticMetaObject = {
    { &QCommonStyle::staticMetaObject, qt_meta_stringdata_QProxyStyle,
      qt_meta_data_QProxyStyle, &staticMetaObjectExtraData }
};
