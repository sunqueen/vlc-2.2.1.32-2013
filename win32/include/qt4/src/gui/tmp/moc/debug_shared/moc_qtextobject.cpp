...
const QMetaObjectExtraData QTextObject::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTextObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTextObject,
      qt_meta_data_QTextObject, &staticMetaObjectExtraData }
};
...
const QMetaObjectExtraData QTextBlockGroup::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTextBlockGroup::staticMetaObject = {
    { &QTextObject::staticMetaObject, qt_meta_stringdata_QTextBlockGroup,
      qt_meta_data_QTextBlockGroup, &staticMetaObjectExtraData }
};
...
const QMetaObjectExtraData QTextFrame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTextFrame::staticMetaObject = {
    { &QTextObject::staticMetaObject, qt_meta_stringdata_QTextFrame,
      qt_meta_data_QTextFrame, &staticMetaObjectExtraData }
};
