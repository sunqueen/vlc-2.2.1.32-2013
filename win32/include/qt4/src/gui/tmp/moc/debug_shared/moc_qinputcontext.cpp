...
void QInputContext::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QInputContext::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QInputContext::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QInputContext,
      qt_meta_data_QInputContext, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QInputContext::getStaticMetaObject() { return staticMetaObject; }
