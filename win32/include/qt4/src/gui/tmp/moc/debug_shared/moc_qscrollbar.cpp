...
const QMetaObjectExtraData QScrollBar::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QScrollBar::staticMetaObject = {
    { &QAbstractSlider::staticMetaObject, qt_meta_stringdata_QScrollBar,
      qt_meta_data_QScrollBar, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QScrollBar::getStaticMetaObject() { return staticMetaObject; }
