...
const QMetaObjectExtraData QAbstractSlider::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QAbstractSlider::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QAbstractSlider,
      qt_meta_data_QAbstractSlider, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QAbstractSlider::getStaticMetaObject() { return staticMetaObject; }
