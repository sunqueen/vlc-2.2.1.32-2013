...
const QMetaObjectExtraData QTreeWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTreeWidget::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_QTreeWidget,
      qt_meta_data_QTreeWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QTreeWidget::getStaticMetaObject() { return staticMetaObject; }
