...
const QMetaObjectExtraData QMessageBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QMessageBox::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QMessageBox,
      qt_meta_data_QMessageBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QMessageBox::getStaticMetaObject() { return staticMetaObject; }
