...
//    avi_index_t p_idx_indx[p_sys->i_track];
    avi_index_t *p_idx_indx = (avi_index_t *)malloc(sizeof(avi_index_t) *p_sys->i_track);			// sunqueen modify
//    avi_index_t p_idx_idx1[p_sys->i_track];
    avi_index_t *p_idx_idx1 = (avi_index_t *)malloc(sizeof(avi_index_t) *p_sys->i_track);			// sunqueen modify
    for( unsigned i = 0; i < p_sys->i_track; i++ )
    {
