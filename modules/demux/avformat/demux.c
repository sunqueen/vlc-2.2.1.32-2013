 ...
 * $Id: 826b78e0dd67b5f248176898dcb1e19a5a8f8f86 $
 *
...
int OpenDemux( vlc_object_t *p_this )
{
    ...
    demux_sys_t   *p_sys;
    AVProbeData   pd = { 0 };			// sunqueen modify
...
//    AVDictionary *options[p_sys->ic->nb_streams ? p_sys->ic->nb_streams : 1];
    AVDictionary **options = (AVDictionary **)malloc(sizeof(AVDictionary **) * (p_sys->ic->nb_streams ? p_sys->ic->nb_streams : 1));			// sunqueen modify
    options[0] = NULL;
