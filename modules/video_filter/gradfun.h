...
#include "gradfun_asm.h"			// sunqueen add
...
static void filter_line_mmx2(uint8_t *dst, uint8_t *src, uint16_t *dc,
                             int width, int thresh, const uint16_t *dithers)
{
	cover_filter_line_mmx2(dst, src, dc, width, thresh, dithers);			// sunqueen add
...
static void filter_line_ssse3(uint8_t *dst, uint8_t *src, uint16_t *dc,
                              int width, int thresh, const uint16_t *dithers)
{
	cover_filter_line_ssse3(dst, src, dc, width, thresh, dithers);			// sunqueen add
// sunqueen delete start
#if 0
    intptr_t x;
    if (width&7) {
