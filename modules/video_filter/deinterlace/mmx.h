...
#define    mmx_i2r(op,imm,reg) \
    __asm__ __volatile__ (#op " %0, %%" #reg \
                  ...
                  : #reg)
#endif
#define    mmx_i2r(op,imm,reg) __asm op reg, imm
...
#define    mmx_m2r(op,mem,reg) \
    __asm__ __volatile__ (#op " %0, %%" #reg \
                  ...
                  : #reg)
#endif
#define    mmx_m2r(op,mem,reg) __asm op reg, mem
...
#define    mmx_r2m(op,reg,mem) \
    __asm__ __volatile__ (#op " %%" #reg ", %0" \
                  ...
                  : "memory")
#endif
#define    mmx_r2m(op,reg,mem) __asm op mem, reg

#if 0
#define    mmx_r2r(op,regs,regd) \
    __asm__ __volatile__ (#op " %%" #regs ", %%" #regd ::: #regd)
#endif
#define    mmx_r2r(op,regs,regd) __asm op regd, regs
