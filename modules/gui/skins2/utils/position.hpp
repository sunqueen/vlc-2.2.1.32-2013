 ...
 * $Id: a02b3d9c2d48491bd0930e2cdbd9f8122653ce07 $
 *
...
//    static int min( int x, int y ) { return x < y ? x : y; }			// sunqueen delete
//    static int max( int x, int y ) { return x < y ? y : x; }			// sunqueen delete
